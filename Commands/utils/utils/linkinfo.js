        ...
        async function analyzeLink(url) {
            ...
            return {
                ...
                scanResults: {
                    ...
                    harmless: scanResults.harmless !== 0 ? scanResults.harmless : undefined,
                    suspicious: scanResults.suspicious !== 0 ? scanResults.suspicious : undefined,
                    malicious: scanResults.malicious !== 0 ? scanResults.malicious : undefined,
                },
            };
        }
